     ...
     &    ,set_coord_to_origin
        ...
        PUBLIC  :: realign_principal_axes
        PUBLIC  :: calc_tensor_eig
        PUBLIC  :: calc_inertia_tensor
        PUBLIC  :: calc_diag
        PUBLIC  :: calc_product


! not used for production, testing only
        PUBLIC  :: eig_rotate
        PUBLIC  :: print_matrix
        PUBLIC  :: diag_tensor
        PUBLIC  :: print_eigs
        PUBLIC  :: printout_single_eigs
        PUBLIC  :: print_inertia_tensor
        PUBLIC  :: realign_eig_vec
        PUBLIC  :: realign_to_zaxes
        PUBLIC  :: rotate_anticlock
